...
import com.mingko.simplemoduo.model.event.xpg.DeviceDataChangedEvent;
import com.mingko.simplemoduo.model.event.xpg.GetBoundDeviceEvent;
import com.mingko.simplemoduo.model.event.xpg.GetDeviceDataEvent;
import com.mingko.simplemoduo.model.event.xpg.GetXpgUserInfoEvent;
import com.mingko.simplemoduo.model.event.xpg.UnbindResultEvent;
import com.mingko.simplemoduo.model.event.xpg.XPGLoginResultEvent;
import com.mingko.simplemoduo.model.event.xpg.XPGLogoutEvent;
import com.mingko.simplemoduo.model.event.xpg.XpgDeviceLoginEvent;
import com.mingko.simplemoduo.model.event.xpg.XpgDeviceOnLineEvent;
...
//            }
    ...
    public void refreshCurrentDeviceListener() {
        ...
        //设置监听器
        currentDevice.setListener(deviceListener);
    }

    //登陆当前设备
    public boolean loginCurrentDevice() {
        if (currentDevice == null) {
            Timber.e("currentDevice 为 null");
            return false;
        }
    ...
    //登出当前设备
    public boolean logoutCurrentDevice() {
        if (currentDevice == null) {
        ...
        Timber.e("登出:\t" + currentDevice.getDid());
        return true;
    }
